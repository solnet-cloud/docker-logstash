...
#      --tag="logstash:0.1.2" --memory="4429185024" --memory-swap="-1"
...
LABEL Description="This image is used to stand up a logstash instance." Version="0.1.2"
...
ADD config/*.conf /ls-data/conf/ # Add all configuration files in config/
